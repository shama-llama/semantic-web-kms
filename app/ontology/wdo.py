...
class WDOOntology(BaseOntology):
    """
    Dynamic WDO ontology wrapper. Loads the WDO ontology from OWL and provides dynamic class/property lookup and superclass traversal.
    ...
    def get_top_level_bfo_ancestor(self, class_uri):
        """Return the top-level BFO ancestor for a given class URI."""
