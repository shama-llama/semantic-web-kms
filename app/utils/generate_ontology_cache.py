...
def main():
    ...
    object_prop_uris = [str(s) for s in ontology.graph.subjects(predicate=None, object=OWL.ObjectProperty)]
    object_properties = sorted({get_local_name(uri) for uri in object_prop_uris})

    # Data Properties
    data_prop_uris = [str(s) for s in ontology.graph.subjects(predicate=None, object=OWL.DatatypeProperty)]
    data_properties = sorted({get_local_name(uri) for uri in data_prop_uris})

    # Annotation Properties
    annotation_prop_uris = [str(s) for s in ontology.graph.subjects(predicate=None, object=OWL.AnnotationProperty)]
    annotation_properties = sorted({get_local_name(uri) for uri in annotation_prop_uris})
