"""
Ontology Cache Utility

This module provides utilities to load and manage the WDO ontology cache
from the JSON file, ensuring strict alignment with the actual ontology structure.
"""
...
def get_code_extraction_properties() -> List[str]:
    ...
    return [
        # Object Properties
        'declaresCode', 'hasMethod', 'hasField', 'hasParameter', 'hasArgument', 'hasReturnType', 'hasType',
        'callsFunction', 'invokes', 'accesses', 'extendsType', 'implementsInterface', 'imports',
        'isMethodOf', 'hasDocumentComponent', 'isElementOf', 'bearerOfInformation', 'informationBorneBy',
        # Data Properties
        'hasSourceCodeSnippet', 'hasSimpleName', 'hasCanonicalName', 'hasLineCount',
        'startsAtLine', 'endsAtLine', 'hasCyclomaticComplexity', 'isAsynchronous',
        'hasAccessModifier', 'hasContent', 'hasTextValue'
    ]
...
def get_code_extraction_classes() -> List[str]:
    ...
    return [
        'ClassDefinition', 'FunctionDefinition', 'AttributeDeclaration', 'Parameter', 'VariableDeclaration',
        'FunctionCallSite', 'ImportDeclaration', 'CodeComment', 'Type', 'ComplexType', 'PrimitiveType',
        'InterfaceDefinition', 'EnumDefinition', 'StructDefinition', 'SourceCodeFile', 'SoftwareCode',
        'InformationContentEntity', 'DigitalInformationCarrier'
    ]
...
def get_file_extraction_properties() -> List[str]:
    ...
    return [
        # Object Properties
        'hasRelativePath', 'hasExtension', 'hasSimpleName', 'bearerOfInformation', 'informationBorneBy',
        'hasDocumentComponent', 'hasContent', 'hasSizeInBytes', 'hasCategory', 'hasCanonicalName',
        'hasLineCount', 'hasType', 'hasField', 'hasMethod', 'hasParameter', 'hasProjectOutput',
        'hasRepository', 'hasReturnType', 'hasSoftwareLicense', 'hasSpecificLicense', 'hasArgument', 
        'hasCommit', 'hasTextValue', 'isElementOf', 'startsAtLine', 'endsAtLine', 'hasResource', 
        'modifies', 'isAbout',
        # Data Properties
        'hasCreationTimestamp', 'hasModificationTimestamp'
    ]
...
def get_git_extraction_properties() -> List[str]:
    ...
    return [
        # Object Properties
        'hasCommit', 'modifies', 'isAbout', 'hasSimpleName', 'hasRepository', 'hasCommitMessage',
        # Data Properties
        'hasCommitHash', 'hasContent'
    ]
...
def get_git_extraction_classes() -> List[str]:
    ...
    return [
        'Repository', 'Commit', 'InformationContentEntity', 'DigitalInformationCarrier'
    ]
...
def get_doc_extraction_properties() -> List[str]:
    ...
    return [
        # Object Properties
        'hasRelativePath', 'hasExtension', 'hasSimpleName', 'bearerOfInformation', 'informationBorneBy',
        'hasDocumentComponent', 'isElementOf',
        # Data Properties
        'hasContent', 'hasTextValue', 'startsAtLine', 'endsAtLine'
    ] 