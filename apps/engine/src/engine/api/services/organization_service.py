...
def get_organization_details(org_id: str):
    ...
    details_query = load_query('organizations/get_organization_details.rq').format(org_id=org_id)
    ...
    # 2. File count
    file_count_query = load_query('organizations/get_organization_file_count.rq').format(org_id=org_id)
    ...
    rel_count_query = load_query('organizations/get_organization_relationship_count.rq').format(org_id=org_id)
